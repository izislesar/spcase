import { type MotionStyle, motion, type Variants } from "motion/react";
 ...
 * ancestor the scene renders statically). The outer motion.g wrappers
 * carry optional pointer/scroll depth MotionValues from the hero — nesting
 * keeps depth values and entrance transforms on separate elements.
 */
...
export interface HeroSceneDepth {
  field?: MotionStyle;
  docs?: MotionStyle;
  machine?: MotionStyle;
  flag?: MotionStyle;
...
export function HeroScene({
  ...
  return (
    <svg className={className} viewBox="0 0 960 640" aria-hidden="true" focusable="false">
      ...
      <motion.g style={depthStyles?.field}>
      ...
      <motion.g style={depthStyles?.docs}>
      ...
      <motion.g style={depthStyles?.machine}>
      ...
      <motion.g style={depthStyles?.flag}>
